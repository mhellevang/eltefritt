...
(function (globalScope) {
  ...
  const MESSAGES = {
    nb: {
      ...
      'mode.cold.detail': 'Kort bulkheving + lang etterheving i kjøleskap (banneton-vennlig).',
      ...
      'aria.field.coldProof': 'etterheving i kjøleskap',
    ...
    en: {
      ...
      'mode.cold.detail': 'Short bulk rise + long final proof in the fridge (banneton-friendly).',
      ...
      'aria.field.coldProof': 'final proof in the fridge',
